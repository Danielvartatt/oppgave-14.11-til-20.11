...
countVowels("Hei på deg")  skal returnere 4
 Prøv med flere test cases!
...
sumRange(1, 5)  skal returnere 15
 Prøv med flere test cases!
...
countOccurences("Hello World!", "l")  skal returnere 2
countOccurences("Hello World!", "æ")  skal returnere 0
 Prøv med flere test cases!
...
removeDuplicates([1, 2, 2, 3, 4, 4, 5]); // skal returnere: [1, 2, 3, 4, 5]
removeDuplicates(["Harald", "Håkon", "Harald", "Bjarne", "Grethe"]); // skal returnere: ["Harald", "Håkon", "Bjarne", "Grethe"]
 Prøv med flere test cases!
/*/
